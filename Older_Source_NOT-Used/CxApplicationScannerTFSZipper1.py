...
# ass CxApplicationScannerTFSZipper(interface.implements(CxApplicationScannerInterfaceZipper)):
@implementer(CxApplicationScannerInterfaceZipper)
class CxApplicationScannerTFSZipper(object):

    sClassMod                 = __name__;
    sClassId                  = "CxApplicationScannerTFSZipper";
    sClassVers                = "(v1.0201)";
