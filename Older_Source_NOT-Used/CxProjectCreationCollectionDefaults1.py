...
class CxProjectCreationCollectionDefaults:

    sClassMod  = __name__;
    sClassId   = "CxProjectCreationCollectionDefaults";
    sClassVers = "(v1.0112)";
...
def main():
    ...
    try:
        ...
        if bMainVerbose == True:
            ...
            cxProjectCreationCollectionDefaults = CxProjectCreationCollectionDefaults(trace=bMainVerbose);
        ...
        #   cxProjectCreation1.setCxProjectPresetName(cxprojectpresetname=dictProjectCreationProperties["project.cx.presetname"]); 
            ...
            for sCxProjectBranchName in asCxProjectBranchNames:
                ...
                print("#(%d) of (%d): 'sCxProjectBranchedName' is [%s]..." % (cCxProjectBranchedName, len(asCxProjectBranchNames), sCxProjectBranchedName));

            print("");

    except Exception as inst:

        print("%s 'main()' - exception occured..." % (CxProjectCreationCollectionDefaults.sClassDisp));
        print(type(inst));
        print(inst);
...
if __name__ == '__main__':
    ...
    if bCmdExecOk == False:
        ...
        print("%s Exiting with a Return Code of (31)..." % (CxProjectCreationCollectionDefaults.sClassDisp));

        sys.exit(31);

    print("%s Exiting with a Return Code of (0)..." % (CxProjectCreationCollectionDefaults.sClassDisp));
