...
def main():
    ...
    try:
        ...
        print "%s The Checkmarx Project 'statistics' via Rest API #1 is starting execution from Server [%s] on [%s]..." % (sScriptDisp, sServerNode, sDTNowStamp);
        print "";
        ...
        if bVerbose == True:
            ...
            print "";
            print "%s CxProjectDataCollection (after load) is:" % (sScriptDisp);
            print cxProjCollection.toString();
            print "";
        ...
        if asCxProjectDataCollectionReport != None and \
            len(asCxProjectDataCollectionReport) > 0:
        ...
        print "";
        print "%s The Checkmarx Project 'statistics' via Rest API #1 is ending execution from Server [%s] on [%s]..." % (sScriptDisp, sServerNode, sDTNowStamp);
        print "";
